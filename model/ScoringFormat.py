...
def get_scoring_map():
    ...
    scoring['fum_rec'] = 2.0
    scoring['int'] = 2.0
    scoring['forced_fumble'] = 1.0
    scoring['fg_made_50p'] = 5.0
    scoring['fg_made_40_49'] = 4.0
    scoring['fg_made_30_39'] = 3.0
    scoring['fg_made_20_29'] = 3.0
    scoring['fg_made_0_19'] = 3.0
    scoring['xp_made'] = 1.0
    scoring['fg_miss'] = -1.0
    scoring['xp_miss'] = -1.0
